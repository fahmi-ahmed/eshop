...
<div class="container-in">
  <?= form_open_multipart('Staff/gamingtools','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <input class="form-control" type="text" name="tooltype" placeholder="tool_type">
        <b style="color: red;"><?php echo form_error('tooltype'); ?></b>
        <br>
