...
<div class="container-in">
  <?= form_open_multipart('Staff/mobile','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
        ...
        <br>
        <input class="form-control" type="text" name="memory" placeholder="memory">
        <b style="color: red;"><?php echo form_error('memory'); ?></b>
      </div>
      <div class="col-md-6">
        <input class="form-control" type="text" name="display" placeholder="display">
        <b style="color: red;"><?php echo form_error('display'); ?></b>
        <br>
        <input class="form-control" type="text" name="batterylife" placeholder="battery life">
        <b style="color: red;"><?php echo form_error('batterylife'); ?></b>
        <br>
        <input class="form-control" type="text" name="camera" placeholder="camera">
        <b style="color: red;"><?php echo form_error('camera'); ?></b>
        <br>
