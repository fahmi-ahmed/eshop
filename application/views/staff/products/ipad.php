...
<div class="container-in">
  <?= form_open_multipart('Staff/ipad','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
        ...
        <br>
       	<input class="form-control" type="text" name="screensize" placeholder="screensize">
        <b style="color: red;"><?php echo form_error('screensize'); ?></b>
        <br>
       	<input class="form-control" type="text" name="tools" placeholder="tools">
        <b style="color: red;"><?php echo form_error('tools'); ?></b>
      </div>
      <div class="col-md-6">
        <input class="form-control" type="text" name="connection" placeholder="connection">
        <b style="color: red;"><?php echo form_error('connection'); ?></b>
        <br>
