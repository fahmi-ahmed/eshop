...
<div class="container-in">
  <?= form_open_multipart('Staff/camera','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
        ...
        <b style="color: red;"><?php echo form_error('name'); ?></b>
      	<br>
        <input class="form-control" type="text" name="lensesize" placeholder="lense_size with the unit">
        <b style="color: red;"><?php echo form_error('lensesize'); ?></b>
      </div>
      <div class="col-md-6">
        <input class="form-control" type="text" name="sdcard" placeholder="sdcard">
        <b style="color: red;"><?php echo form_error('sdcard'); ?></b>
        <br>
