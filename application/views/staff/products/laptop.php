...
<div class="container-in">
  <?= form_open_multipart('Staff/laptop','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
        ...
        <br>
        <input class="form-control" type="text" name="cam" placeholder="cam">
        <b style="color: red;"><?php echo form_error('cam'); ?></b>
      </div>
      <div class="col-md-6">
        <input class="form-control" type="text" name="graphics" placeholder="graphics">
        <b style="color: red;"><?php echo form_error('graphics'); ?></b>
        <br>
        <input class="form-control" type="text" name="connectivity" placeholder="connectivity">
        <b style="color: red;"><?php echo form_error('connectivity'); ?></b>
        <br>
