...
<div class="container-in">
  <?= form_open_multipart('Staff/gaminglaptop','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
        ...
        <br>
        <input class="form-control" type="text" name="resolution" placeholder="resolution">
        <b style="color: red;"><?php echo form_error('resolution'); ?></b>
      </div>
      <div class="col-md-6">
