...
<div class="container-in">
  <?= form_open_multipart('Staff/ram','class="form-signin"'); ?>
  	<div class="row">
      <div class="col-md-6">
        ...
        <input class="form-control" type="text" name="ramtype" placeholder="ramtype">
        <b style="color: red;"><?php echo form_error('ramtype'); ?></b>
      </div>
      <div class="col-md-6">
        <input class="form-control" type="text" name="model" placeholder="model">
        <b style="color: red;"><?php echo form_error('modle'); ?></b>
        <br>
        <input class="form-control" type="text" name="pin" placeholder="pin">
        <b style="color: red;"><?php echo form_error('pin'); ?></b>
        <br>
